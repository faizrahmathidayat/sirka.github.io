...
$sqlTampil="select * from anggarantahun,tahun where id_anggarantahun='$id' and anggarantahun.id_tahun=tahun.id_tahun ";
...
<body>
<form class="form-horizontal" method="POST" name='autoSumForm' enctype="multipart/form-data" action="pages/proses/proses_edit_laporan.php">
<input type="hidden" name="id_anggarantahun" value="<?php echo $data['id_anggarantahun'];?>">
 <h1><span class="glyphicon glyphicon-save"></span>&nbsp;&nbsp;EDIT LAPORAN</h1>
     <hr>
     <hr>
     ...
     <div class="form-group">
           ...
           <div class="col-lg-5">
             <input class="form-control background" readonly="" id="tahun" name="tahun" value="<?php echo $data['tahun']; ?>">
             </div>
         </div>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-5">
        <input class="form-control background" name="jmlsiswa" placeholder="0" type="number" onFocus="startCalc();" onBlur="stopCalc();" value="<?php echo $data['jmlsiswa']; ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-5">
        <input class="form-control background" name="jmlanggaran" type="number" onchange='tryNumberFormat(this.form.thirdBox);' value="<?php echo $data['jmlanggaran']; ?>" readonly="readonly"/>
          </div>
      </div>
      ...
      <div class="col-lg-5">
        <input class="form-control background" name="dana1" type="text" placeholder="0" onkeyup="validAngka(this)" onFocus="startCalc();" onBlur="stopCalc();" value="<?php echo $data['dana1']; ?>" />
    ...
    <div class="form-group">
      ...
      <div class="col-lg-5">
        <input class="form-control background" name="dana2" type="text" onkeyup="validAngka(this)" placeholder="0" onFocus="startCalc();" onBlur="stopCalc();"value="<?php echo $data['dana2']; ?>" />
       ...
       <div class="form-group">
         ...
         <div class="col-lg-5">
           <input class="form-control background" name="dana3" type="text" onkeyup="validAngka(this)" placeholder="0" onFocus="startCalc();" onBlur="stopCalc();" value="<?php echo $data['dana3']; ?>" />
       ...
       <div class="form-group">
         ...
         <div class="col-lg-5">
           <input class="form-control background" name="dana4" type="text" onkeyup="validAngka(this)" placeholder="0" onFocus="startCalc();" onBlur="stopCalc();" value="<?php echo $data['dana4']; ?>" />
       ...
       <div class="form-group">
         ...
         <div class="col-lg-5">
           <input class="form-control background" name="dana5" type="text" onkeyup="validAngka(this)" placeholder="0" onFocus="startCalc();" onBlur="stopCalc();" value="<?php echo $data['dana5']; ?>"/>
       ...
       <div class="form-group">
         ...
         <div class="col-lg-5">
           <input class="form-control background" name="dana6" type="text" onkeyup="validAngka(this)" placeholder="0" onFocus="startCalc();" onBlur="stopCalc();" value="<?php echo $data['dana6']; ?>" />
       ...
       <div class="form-group">
         ...
         <div class="col-lg-5">
           <input class="form-control background" name="selisih" type="number" onchange='tryNumberFormat(this.form.thirdBox);' value="<?php echo $data['selisih']; ?>" readonly="readonly"/>
